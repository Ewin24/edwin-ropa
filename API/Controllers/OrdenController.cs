...
namespace API.Controllers
{
    public class OrdenController : BaseController
    {
        ...
        public OrdenController(IUnityOfWork unitOfWork, IMapper mapper){
        ...
        public async Task<ActionResult<IEnumerable<Orden>>> Get(){
            var items = await _UnitOfWork.Orden.GetAllAsync();
            return Ok(items);
        }
        ...
        public async Task<ActionResult<IEnumerable<Orden>>> Get(int id){
            var item = await _UnitOfWork.Orden.GetByIdAsync(id);
            return Ok(item); 
        }
        ...
        public async Task<ActionResult<Orden>> Post(OrdenDto itemDto){
            ...
            this._UnitOfWork.Orden.Add(item);
