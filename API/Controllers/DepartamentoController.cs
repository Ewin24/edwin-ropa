...
namespace API.Controllers
{
    public class DepartamentoController : BaseController
    {
        ...
        public DepartamentoController(IUnityOfWork unitOfWork, IMapper mapper){
        ...
        public async Task<ActionResult<IEnumerable<Departamento>>> Get(){
            var items = await _UnitOfWork.Departamento.GetAllAsync();
            return Ok(items);
        }
        ...
        public async Task<ActionResult<IEnumerable<Departamento>>> Get(int id){
            var item = await _UnitOfWork.Departamento.GetByIdAsync(id);
            return Ok(item); 
        }
        ...
        public async Task<ActionResult<Departamento>> Post(DepartamentoDto itemDto){
            ...
            this._UnitOfWork.Departamento.Add(item);
        ...
        public async Task<ActionResult<Departamento>> Put(int id, [FromBody] Departamento item){
            ...
            _UnitOfWork.Departamento.Update(item);
            await _UnitOfWork.SaveAsync();
            return item;
        }
        [HttpDelete("{id}")]
        ...
        public async Task<ActionResult> Delete(int id){
            ...
            _UnitOfWork.Departamento.Delete(item);
            await _UnitOfWork.SaveAsync();
            return NoContent();
        }
    }
